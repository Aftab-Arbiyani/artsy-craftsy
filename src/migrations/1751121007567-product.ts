...
export class Product1751121007567 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "title" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."product_orientation_enum" AS ENUM('portrait', 'landscape', 'square', 'circular')`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "orientation" "public"."product_orientation_enum" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "quantity" integer NOT NULL DEFAULT '1'`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "height" double precision NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "width" double precision NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "depth" double precision`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "weight" double precision`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "tax" double precision NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "listing_price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "discount" numeric(5,2) NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "amount_receivable" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "is_copyright_owner" boolean NOT NULL DEFAULT false`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" DROP COLUMN "is_copyright_owner"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" DROP COLUMN "amount_receivable"`,
    );
    await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "discount"`);
    await queryRunner.query(
      `ALTER TABLE "product" DROP COLUMN "listing_price"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "artist" character varying(100) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "image_url" character varying`,
    );
    await queryRunner.query(
